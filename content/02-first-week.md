...
category: start
summary: A day-by-day plan from a fresh Sanctuary to level 10 and beyond, without the mistakes that stall most players.
tags: beginner, sanctuary, stars, clinic
updated: 2026-09-12
---
...
## Days 2 to 3: Sanctuary 6 and 7

Sanctuary 6 and 7 are the two big early gates.

| Level | Needs | Unlocks |
|---|---|---|
| 5 | Walls 3, 28 Stars | Antitoxin, Smelting, Weaving Workshops. Daily missions. |
| 6 | Walls 5, 47 Stars | Barracks, Training Grounds, Alliance Hall, Falcon Tower (world map), Nomad Trader. |
| 7 | Training Grounds 4, Alliance Hall 3, 61 Stars | Research Lab, Raven Nest, Arena, Warrior Statue. First free 8-hour shield. Survival Battle. |

- [ ] Keep **Walls** within a few levels of the Sanctuary. They are a prerequisite at 5, 6, 9 and 10.
- [ ] Build the **Alliance Hall** the moment Sanctuary 6 lands and start asking for help.
- [ ] Open the **Falcon Tower**: it unlocks chat, the world map and Falcon Quests (your daily quest board, refreshes every 6 hours).
- [ ] Start the **Research Lab** at Sanctuary 7 and never let it sit idle. From Sanctuary 10 onward the Lab must be one level below your target Sanctuary level or the upgrade is blocked.

> **Tip:** Never let a build queue or research queue sit empty. If you are about to sleep, queue the longest thing you can afford.
...
> **Avoid:** Rushing the Sanctuary while ignoring the Lab and Training Grounds. You will stall at 7, 8, 10 and 15 waiting on prerequisites.

> **Avoid:** Opening **Level Supplies** boxes as soon as they drop. They pay out based on your Sanctuary level at the moment you open them. An Antitoxin UR supply gives 670k at level 1 and 38 million at level 35. Hold them.

> **Avoid:** Spending diamonds on speedups or plain diamond packs. Diamonds go to build queues, VIP 5, and shields in emergencies. Nothing else early.
...
Nothing, yet. Bank them toward VIP Status or a 24-hour shield during your first war week. If you plan to spend real money at all, the $1.99 second build queue is the single best purchase in the game. See [Spending and VIP](#/spending-vip).
