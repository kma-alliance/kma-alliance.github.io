...
category: solo
summary: Sixty difficulties across three faction arenas that refresh Sunday, Tuesday and Thursday. Missed windows never come back.
tags: expedition, expedition medals, arenas, gearstones
updated: 2026-09-13
---
...
| | |
|---|---|
| Needs | Sanctuary 16. Warrior Arena first; Ranger after Warrior difficulty 8; Warlock after Warrior difficulty 12 |
| Structure | 3 branches × 20 levels = 60 difficulties, each cleared once for Expedition Medals |
...
> **KMA:** Put the three refresh days in your routine. The Sunday, Tuesday and Thursday windows are the only ones that exist.
